...
function(exports) {
    ...
    tree.prototype.template = function(data) {
        ...
        function(index, item) {
            ...
            tbody += '<tr  data-rush="' + item.rush + '" data-name="' + item.name + '" data-leader-id="' + item.leader_id + '" data-tb-id="' + item.id + '" data-tb-pid="' + item.pid + '" ' + hide_class + ">";
            o.each(t.c.cols,
            function(idx, obj) {
                if (obj["data"]) {
                ...
                if (obj.field == t.c.field) {
                    ...
                    if (t.c.childs[item.id]) {
                        tbody += '<i style="" class="layui-icon ' + t.c.icon_class + '">' + (item.id == t.cache(item.id) || t.c.is_open ? t.c.icon_val.close: t.c.icon_val.open) + "</i>"
    ...
    tree.prototype.render = function(e) {
        ...
        o(t.c.elem).html(template).on("click", "td",
        function() {
