...
class WxPayAppPay extends WxPayDataBase
{
	...
	public function SetAppSign($value)
	{
 ...
 *
 */
class WxCompanyPay extends WxPayDataBase
{
    /**
     * 设置微信分配的公众账号ID
     * @param string $value
    ...
    /**
     * 设置是否效验姓名
     * @param string $value  NO_CHECK：不校验真实姓名  FORCE_CHECK：强校验真实姓名
     **/
    ...
    /**
     * 此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 是否存在
     * @return true 或 false
     **/
    public function IsOpenidSet()
    {
 ...
 *
 */
class GetWxCompanyPay extends WxPayDataBase
{
	/**
	 * 设置微信分配的公众账号ID
	 * @param string $value
