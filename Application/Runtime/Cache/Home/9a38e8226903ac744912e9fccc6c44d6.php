            ...
            <div class="layui-card-body">
                <div class="layui-form" >
                    <div class="layui-form-item" style="margin-top:0">
                        ...
                        <?php if(in_array('search_order/apply_time',$search_power)): ?><div class="my_form_box">
...
//所属部门
        ...
        var Machine = table.render({
            elem: '#Machine'
            ,url: 'order_tui.html?search_data=1' //数据接口
            ,page: true //开启分页
            ,cellMinWidth:180
            ,cols: [[ //表头
                ...
                {width:280,itemplet:'#demand', title: '工单'},
...
//监听左侧表格
        table.on('tool(Machine)', function(obj){
            ...
            if(layEvent==='order_link'){
                ...
                get_url(this,ids,url,"已退订单："+data.code);
            }
            //工单详情
