...
<div class="layui-content">
					...
					<div class="layui-form" action="">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="title" value="<?php echo $_GET['tel'];?>" disabled placeholder="请输入手机号" autocomplete="off" class="layui-input search_input">
							</div>
						</div>	
					</div>	
			</div>
	...
	<?php if($_GET['tel'] && !$res): ?><div id="form" class="layui-form layui-row" <?php if($cus): ?>style="display:none;"<?php endif; ?> >
		...
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<div class="layui-input-inline">
				<input type="number" name="idcard"  value="<?php echo ($cus["idcard"]); ?>" placeholder="请输入身份证号码" autocomplete="off" class="layui-input ">
			</div>
		</div>	
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			<label class="layui-form-label">客户生日&nbsp;</label>
			<div class="layui-input-inline">
				<input type="text" name="birth" id="birth" value="<?php echo ($cus["birth"]); ?>"  placeholder="请选择客户生日" autocomplete="off" class="layui-input ">
			</div>
		</div>	
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			<label class="layui-form-label">客户年龄&nbsp;</label>
			<div class="layui-input-inline">
				<input type="number" name="age"  value="<?php echo ($cus["age"]); ?>" placeholder="请输入客户年龄" autocomplete="off" class="layui-input ">
			</div>
		</div>	
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<select name="sex" lay-filter="aihao">
				<option value="1" <?php if($cus['sex'] == '男'): ?>selected<?php endif; ?> >男</option>
				<option value="2" <?php if($cus['sex'] == '女'): ?>selected<?php endif; ?> >女</option>
				<option value="0" <?php if($cus['sex'] == '未知'): ?>selected<?php endif; ?>>未知</option>
			</select>
			</div>
		</div>
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<div class="layui-input-inline">
				<input type="text" name="huji" value="<?php echo ($cus["huji"]); ?>"  placeholder="请输入户口所在" autocomplete="off" class="layui-input ">
			</div>
		</div>	
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			<label class="layui-form-label">客户地址&nbsp;</label>
			<div class="layui-input-inline">
				<input type="text" name="address"  value="<?php echo ($cus["address"]); ?>"   placeholder="请输入客户地址" autocomplete="off" class="layui-input ">
			</div>
		</div>	
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			<label class="layui-form-label">客户邮箱&nbsp;</label>
			<div class="layui-input-inline">
				<input type="text" name="email"  value="<?php echo ($cus["email"]); ?>"  placeholder="请输入邮箱" autocomplete="off" class="layui-input ">
			</div>
		</div>
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<div class="layui-input-inline">
			  <select name="marriage">
					<option value="0" <?php if($cus['marriage'] == 0): ?>selected<?php endif; ?> >未知</option>
					<option value="1" <?php if($cus['marriage'] == 1): ?>selected<?php endif; ?> >已婚</option>
					<option value="2" <?php if($cus['marriage'] == 2): ?>selected<?php endif; ?> >未婚</option>
					<option value="3" <?php if($cus['marriage'] == 3): ?>selected<?php endif; ?> >离异</option>
					<option value="4" <?php if($cus['marriage'] == 4): ?>selected<?php endif; ?> >丧偶</option>
					<option value="5" <?php if($cus['marriage'] == 5): ?>selected<?php endif; ?> >再婚</option>
			  </select>
			</div>
		</div>
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<select name="education" >
				<option value="0" <?php if($cus['education'] == 0): ?>selected<?php endif; ?>>未知</option>
				<option value="1" <?php if($cus['education'] == 1): ?>selected<?php endif; ?>>高中以下</option>
				<option value="2" <?php if($cus['education'] == 2): ?>selected<?php endif; ?>>大专</option>
				<option value="3" <?php if($cus['education'] == 3): ?>selected<?php endif; ?>>本科</option>
				<option value="4" <?php if($cus['education'] == 4): ?>selected<?php endif; ?>>硕士及以上</option>
			</select>
			</div>
		</div>
		<div class="layui-form-item sj_form layui-col-md3 layui-col-xs12">
			...
			<div class="layui-input-inline">
				<select name="child">
					<option value="0" <?php if($cus['child'] == 0): ?>selected<?php endif; ?>>0</option>
					<option value="1" <?php if($cus['child'] == 1): ?>selected<?php endif; ?>>1</option>
					<option value="2" <?php if($cus['child'] == 2): ?>selected<?php endif; ?>>2</option>
					<option value="3" <?php if($cus['child'] == 3): ?>selected<?php endif; ?>>3</option>
					<option value="4" <?php if($cus['child'] == 4): ?>selected<?php endif; ?>>4</option>
					<option value="5" <?php if($cus['child'] == 5): ?>selected<?php endif; ?>>5</option>
					<option value="6" <?php if($cus['child'] == 6): ?>selected<?php endif; ?>>6</option>
				</select>
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text sj_form layui-col-xs12">
			...
			<div class="layui-input-block" style="margin-left:80px;">
			  <textarea name="remark" placeholder="请输入内容" class="layui-textarea"><?php echo ($cus["remark"]); ?></textarea>
			</div>
		</div>
