                    ...
                    <div class="layui-form-item" style="margin-top:0">
                        <?php if(in_array('search_order/order_code ',$search_power)): ?><div class="my_form_box">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="code" placeholder="订单编号" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div><?php endif; ?>
                        <?php if(in_array('search_order/money',$search_power)): ?><div class="my_form_box">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="dk_money_start" style="display: inline-block;width:79px;"
                                           onkeyup="je(this)" placeholder="最小金额" autocomplete="off" class="layui-input">
                                    <span style="clear:both">-</span>
                                    <input type="text" name="dk_money_end" style="display: inline-block;width:79px;"
                        ...
                        <?php if(in_array('search_order/part',$search_power)): ?><div class="my_form_box">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="part_id" id="tree" placeholder="订单所属部门" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div><?php endif; ?>
                        <?php if(in_array('search_order/creat_time',$search_power)): ?><div class="my_form_box">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="apply_time" id="apply_time" placeholder="下单时间"
...
<script id="demand" type="text/html">
    ...
    <p><span lay-event="demand_link" data-code="{{item.demand_code}}" data-id="{{item.demand_id}}"
             style="color:#01AAED;cursor: pointer;">
		{{item.demand_code}}</span>-{{item.demand_step?item.demand_step:''}}-{{item.demand_status?item.demand_status:''}}
    </p>
    {{#  }); }}
</script>
...
//所属部门
        ...
        var Machine = table.render({
            ...
            , cols: [[ //表头
                ...
                {width: 180, field: 'accept_user', title: '接单人'}
            ]]
            , response: {
                statusCode: 200
            }
...
//监听左侧表格
        table.on('tool(Machine)', function (obj) {
            ...
            if (layEvent === 'order_link') {
                ...
                get_url(this, ids, url, "已完成订单：" + data.code);
            }
            //工单详情
