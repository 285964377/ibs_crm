...
(function ($) {
  ...
  TreeSelect.prototype.checkNode = function(filter, id){
    ...
    var treeInput = o.find('.layui-select-title input');
	var treeObj = obj.treeObj(filter);
  ...
  var obj = {
    filter: function(filter){
      ...
      var   o = tf.next();
	  if(o.attr('class')!='layui-treeSelect layui-unselect layui-form-select'){
		  layui.hint().error('请不要在filter后面加元素');
	  }
      return o;
    },
	...
	//console.log(o);
	 ...
	 //  console.log("class:"+o.find('.layui-treeSelect-body').attr('class'));
