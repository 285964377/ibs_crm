...
layui.define(['jquery'], function(exports) {
  ...
  var noticeObj = {
    ...
    init: function($data) {
      ...
      var noticeObjHtml = '<div class="layui-container layui-anim layui-anim-up layui-notice" data-id="'+options.id+'" onclick="msg(this)" style="cursor:pointer"><div class="notice ' + classN_ + ' has-radius">';
